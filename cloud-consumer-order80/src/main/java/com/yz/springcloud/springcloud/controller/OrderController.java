...
import com.yz.springcloud.springcloud.lb.LoadBalancer;
...
public class OrderController {
    ...
    public CommonResult<Payment> create2(Payment payment){
        ResponseEntity<CommonResult> post = restTemplate.postForEntity(PAYMENT_URL + "/payment/create", payment, CommonResult.class);
